...
**Site:** farejai.shop  
**URL de Produção:** https://www.farejai.shop  
**Hospedagem:** Vercel  
...
4. **API Integration:** Envia para farejai.shop via API
...
API_SECRET_KEY=farejai-secure-2024-admin-key
NEXT_PUBLIC_BASE_URL=https://www.farejai.shop
...
**Status:** Produção ativa em farejai.shop